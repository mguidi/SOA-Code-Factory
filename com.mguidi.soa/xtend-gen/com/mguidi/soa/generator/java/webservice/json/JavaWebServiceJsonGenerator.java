...
public class JavaWebServiceJsonGenerator implements IGenerator {
  @Inject
  @Extension
    ...
    for (final Service e_1 : services) {
      {
        ...
        CharSequence _format_1 = this.beautifier.format(_generateClient);
    ...
    for (final Operation e_2 : operations) {
      {
        ...
        if (_greaterThan_3) {
          ...
          CharSequence _format_1 = this.beautifier.format(_generateJsonHelper_1);
          fsa.generateFile(_plus_19, _format_1);
        }
      }
    }
