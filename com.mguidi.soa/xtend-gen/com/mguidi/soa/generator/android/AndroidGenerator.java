...
import com.mguidi.soa.generator.android.InstallScriptGenerator;
import com.mguidi.soa.generator.android.ManifestGenerator;
import com.mguidi.soa.generator.android.ModelGenerator;
import com.mguidi.soa.generator.android.OperationInputGenerator;
import com.mguidi.soa.generator.android.OperationOutputGenerator;
...
public class AndroidGenerator {
  ...
  public void doGenerate(final Resource resource, final IFileSystemAccess fsa) {
    ...
    for (final Architecture e : _filter_4) {
      {
        ...
        if (_or) {
          ...
          String _plus_11 = (_plus_10 + "/model/src/main/AndroidManifest.xml");
          CharSequence _generateManifestModel = this.manifestGenerator.generateManifestModel(e);
          fsa.generateFile(_plus_11, _generateManifestModel);
        }
        boolean _or_1 = false;
        ...
        if (_or_1) {
          String _applicationId_2 = this.utils.applicationId(e);
          ...
          String _plus_17 = (_plus_16 + "/service/build.gradle");
          CharSequence _generateBuildService = this.gradleBuildGenerator.generateBuildService(e, resource);
          fsa.generateFile(_plus_17, _generateBuildService);
          String _applicationId_3 = this.utils.applicationId(e);
          String _plus_18 = ("android/" + _applicationId_3);
          ...
          String _plus_22 = (_plus_21 + _version_3);
          String _plus_23 = (_plus_22 + "/service/src/main/AndroidManifest.xml");
          CharSequence _generateManifestService = this.manifestGenerator.generateManifestService(e);
          fsa.generateFile(_plus_23, _generateManifestService);
        }
      }
    }
    ...
    for (final com.mguidi.soa.soa.Enum e_2 : enumerations) {
      ...
      String _plus_8 = ("android/" + _applicationId_1);
      String _plus_9 = (_plus_8 + "/");
    ...
    for (final Service e_3 : services) {
      ...
      if (_greaterThan) {
        ...
        String _plus_16 = ("android/" + _applicationId_2);
        ...
        String _plus_24 = ("android/" + _applicationId_3);
    ...
    for (final Operation e_4 : _filter_5) {
      {
        ...
        if (_greaterThan_1) {
          ...
          String _plus_32 = ("android/" + _applicationId_4);
        ...
        if (_greaterThan_2) {
          ...
          String _plus_40 = ("android/" + _applicationId_5);
  ...
  public void doGenerate(final Set<Resource> resources, final IFileSystemAccess fsa) {
    ...
    fsa.generateFile("android/install_model_script.sh", _generateInstallScriptModel);
    CharSequence _generateInstallScriptService = this.installScriptGenerator.generateInstallScriptService(architectures);
    fsa.generateFile("android/install_service_script.sh", _generateInstallScriptService);
  }
}
