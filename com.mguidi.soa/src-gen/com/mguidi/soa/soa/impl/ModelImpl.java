 ...
 * <ul>
 *   <li>{@link com.mguidi.soa.soa.impl.ModelImpl#getEntities <em>Entities</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ModelImpl extends MinimalEObjectImpl.Container implements Model
{
  ...
  {
    return SoaPackage.Literals.MODEL;
  }
  ...
  public EList<Entities> getEntities()
  {
    if (entities == null)
    {
      entities = new EObjectContainmentEList<Entities>(Entities.class, this, SoaPackage.MODEL__ENTITIES);
    }
    return entities;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SoaPackage.MODEL__ENTITIES:
