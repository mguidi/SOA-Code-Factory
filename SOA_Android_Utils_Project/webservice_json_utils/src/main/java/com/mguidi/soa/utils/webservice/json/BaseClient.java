package com.mguidi.soa.utils.webservice.json;

/**
 * Created by marco on 11/21/14.
 */
public class BaseClient {
     ...
     */
    private static int getNextTimeout(int numTries) {
     ...
     */
    private static boolean isTimeoutException(long startTime, boolean isConnected, long readTimeout, long connectionTimeout) {
